...
public class JdbcUserDaoTests extends BaseDaoTests {
    protected static final User USER_1 = new User(1, "user1", "user1", "ROLE_USER", "a@gmail.com" , LocalDate.now(),1, "https://");
    protected static final User USER_2 = new User(2, "user2", "user2", "ROLE_USER", "a@gmail.com" , LocalDate.now(),1, "https://");
    private static final User USER_3 = new User(3, "user3", "user3", "ROLE_USER", "a@gmail.com" , LocalDate.now(),1, "https://");
...
//        User newUser = new User(-1, "new", "user", "ROLE_USER", "a@gmail.com" , LocalDate.now(),"here", "https://");
//
